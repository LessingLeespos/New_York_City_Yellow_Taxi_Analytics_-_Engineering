...
[ NYC TLC Public Source ]<br>
           ▼<br>
 [ Bronze Layer ]<br>
 Dataflows Gen2 / Lakehouse (`lk_TaxiData`)<br>
(Raw ingestion & initial schema mapping)<br>
           ▼<br>
 [ Silver Layer ]<br>
 Staging Pipelines (`pipeline_nyctaxi` / `df_processing_nyctaxi`)<br>
 (Dynamic date checks, outlier cleanup via Stored Procedures)<br>
           ▼<br>
  [ Gold Layer ]<br>
  Data Warehouse (`wh_NYCTaxi`) & Semantic Model (`sm_yellow_nyctaxi`)<br>
  (Star schema modeling, business aggregation tables)<br>
           ▼<br>
 [ Visualization ]<br>
![NYC Taxi Dashboard](/screenshots/metadata_pipeline.PNG)<br>
